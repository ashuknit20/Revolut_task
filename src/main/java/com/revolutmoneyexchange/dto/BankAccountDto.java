...
public class BankAccountDto {
    ...
    public static final Long DHARM_BANK_ACCOUNT_ID = 1L;
    public static final Long MIKE_BANK_ACCOUNT_ID = 2L;
    public static final Long TEST_USER_BANK_ACCOUNT_ID = 3L;
     ...
     * @throws ObjectMisMatchException if Bank Account with the provided id will not be exists in the database at
     *                                     the moment or object provided is malformed
     */
    public void updateBankAccountSafe(BankAccount bankAccount) throws ObjectMisMatchException {
        ...
        if (bankAccount.getAccountNumber() == null || bankAccount.getOwnerName() == null) {
            throw new ObjectMisMatchException(ExceptionType.BAD_REQUEST_OBJECT, "Id and OwnerName fields could not be NULL");
        }

        DbUtils.QueryExecutor<Integer> queryExecutor = updateBankAccount -> {
            updateBankAccount.setString(1, bankAccount.getOwnerName());
            updateBankAccount.setLong(2, bankAccount.getAccountNumber());
     ...
     * @param con         the <code>Connection</code> to be used for this query
     * @throws ObjectMisMatchException if Bank Account with the provided id will not be exists in the database at the
     *                                     moment or object provided is malformed
     */
    void updateBankAccount(BankAccount bankAccount, Connection con) throws ObjectMisMatchException {
        String UPDATE_BANK_ACCOUNT_SQL =
                "update " + BANK_ACCOUNT_TABLE_NAME +
                        " set " +
                        BANK_ACCOUNT_OWNER_NAME_ROW + " = ?, " +
        ...
        DbUtils.QueryExecutor<Integer> queryExecutor = updateBankAccount -> {
            ...
            updateBankAccount.setLong(5, bankAccount.getAccountNumber());
    ...
    private BankAccount extractBankAccountFromResultSet(ResultSet bankAccountsRS) throws SQLException {
        ...
        bankAccount.setAccountNumber(bankAccountsRS.getLong(BANK_ACCOUNT_ID_ROW));
     ...
     */
    private void verify(BankAccount bankAccount) throws ObjectMisMatchException {
